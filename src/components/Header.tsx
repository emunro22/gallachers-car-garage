...
export default function Header() {
  ...
  return (
    <>
      {/* Top accent bar */}
      <div className="bg-white text-neutral-500 text-sm py-3.5 hidden md:block border-b border-neutral-200">
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span>{BUSINESS.hours.weekday} &middot; {BUSINESS.hours.friday}</span>
          </div>
        </div>
      </div>
