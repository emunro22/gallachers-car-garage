...
export const metadata: Metadata = {
  ...
  description:
    "Looking for a garage near me in Blantyre? Gallachers Car Garage offers Servicing, repairs for all makes. 4.8★ rated, honest prices. Call 01698 711111.",
...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      <ServiceJsonLd name="Garage Near Me - Blantyre" description="Local trusted auto repair garage in Blantyre, South Lanarkshire. Servicing, and all repairs." />
      {children}
    </>
  );
}
