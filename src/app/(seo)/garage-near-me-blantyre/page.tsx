...
export default function GarageNearMeBlantyre() {
  return (
    <SeoServicePage
      title="Garage Near Me Blantyre"
      heading="Garage Near Me"
      headingHighlight="in Blantyre"
      intro="Looking for a reliable garage near you in Blantyre? Gallachers Car Garage is your local trusted auto repair centre in South Lanarkshire."
      paragraphs={[
      ...
      bulletPoints={[
        ...
        "Timing belts, engine work, diagnostics",
        "Tyres and batteries",
        "4.8★ Google rating from 40+ reviews",
        "Honest prices, no hard sell",
        "Serving Blantyre, Hamilton, Bothwell, Uddingston, Cambuslang, East Kilbride",
      ]}
      faqs={[
        {
          question: "Where exactly is Gallachers Car Garage?",
          answer: "We're at Unit 7a, 7b Forrest Street, Blantyre, Glasgow, G72 0JP. We're just off the main road, so search 'Gallachers Car Garage' on Google Maps for easy directions. Look for the blue building with our green sign.",
        },
        {
          question: "What are your opening hours?",
          answer: "We're open Monday to Friday from 8:00am to 5:30pm, and Saturday from 8:00am to 12:30pm. We're closed on Sundays.",
        },
        {
