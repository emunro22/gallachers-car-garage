...
export const metadata: Metadata = {
  ...
  description:
    "Experienced car mechanic in South Lanarkshire. Gallachers Car Garage in Blantyre offers expert repairs, Servicing and diagnostics. 4.8★ rated. Call 01698 711111.",
